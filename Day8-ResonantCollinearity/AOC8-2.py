...
def place_antinode_line(startx, starty, dx, dy, matrix):
    x, y = startx, starty
    while place_antinode(x, y, matrix):
        x += dx
        y += dy
...
def place_antinodes(antennas, matrix):
    ...
    for ant1 in antennas:
        ...
        for ant2 in antenna_queue:
            ...
            place_antinode_line(ant1[0], ant1[1], dx, dy, matrix)
            place_antinode_line(ant2[0], ant2[1], -dx,-dy, matrix)
